...
<html>
    ...
    <body>
        ...
        <table>
            ...
            <tr>
                <td>abs(-5)</td>
                <td class="conversion"><?php var_dump(abs(-5)); ?></td>
            </tr>
            <tr>
                <td>cos(deg2rad(60))</td>
                <td class="conversion"><?php var_dump(cos(deg2rad(60))); ?></td>
            </tr>
            <tr>
                <td>max(5, 8, 3)</td>
                <td class="conversion"><?php var_dump(max(5, 8, 3)); ?></td>
            </tr>
            <tr>
                <td>chunk_split("Hola mundo!",1,".")</td>
                <td class="conversion"><?php var_dump(chunk_split("Hola mundo!", 1, ".")); ?></td>
            </tr>
            <tr>
                <td>chr(52)</td>
            ...
            <tr>
                ...
                <td class="conversion"><?php var_dump(count_chars("Hola World!", 3)); ?></td>
            </tr>
            <tr>
                <td>count_chars("Hola World!", 1)</td>
                <td class="conversion"><?php var_dump(count_chars("Hola World!", 1)); ?></td>
            </tr>
            <tr>
                <td>explode(" ", "Hola mundo. It\'s a beautiful day.")</td>
                <td class="conversion"><?php var_dump(explode(" ", "Hola mundo. It\'s a beautiful day.")); ?></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="conversion"><?php var_dump(ltrim("Hola World!", "Hola")); ?></td>
            </tr>
            <tr>
                <td>ord("hello")</td>
            ...
            <tr>
                ...
                <td class="conversion"><?php var_dump(str_replace("mundo", "tierra", "Hola mundo!")); ?></td>
            </tr>
            <tr>
                <td>str_split("Hola")</td>
                <td class="conversion"><?php var_dump(str_split("Hola")); ?></td>
            </tr>
            <tr>
                <td>str_word_count("Hola mundo!")</td>
                <td class="conversion"><?php var_dump(str_word_count("Hola mundo!")); ?></td>
            </tr>
            <tr>
                <td>strcmp("Hola mundo!","Hola mundo!")</td>
                <td class="conversion"><?php var_dump(strcmp("Hola mundo!", "Hola mundo!")); ?></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="conversion"><?php var_dump(strrev("Hola World!")); ?></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="conversion"><?php var_dump(str_shuffle("Hola")); ?></td>
            </tr>
            <tr>
                <td>strspn("Hola mundo!","kHlleo")</td>
                <td class="conversion"><?php var_dump(strspn("Hola mundo!", "kHlleo")); ?></td>
            </tr>
            <tr>
                <td>strtoupper("Hola WORLD!")</td>
                <td class="conversion"><?php var_dump(strtoupper("Hola WORLD!")); ?></td>
            </tr>
            <tr>
            ...
            <tr>
                <td>strlen("Hola")</td>
                <td class="conversion"><?php var_dump(strlen("Hola")); ?></td>
            </tr>
        </table>
    </body>
</html>
